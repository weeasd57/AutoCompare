...
async function insertVehicle(sample: SampleVehicle) {
    const id = createVehicleId(sample);
    await query(
        `INSERT IGNORE INTO vehicles (
            id, make, model, year, trim, horsepower, engine_cylinders,
            fuel_type, body_style, country, fuel_combined_mpg,
            drivetrain, seating_capacity, base_price, image_url, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
        [
            id,
            sample.make,
